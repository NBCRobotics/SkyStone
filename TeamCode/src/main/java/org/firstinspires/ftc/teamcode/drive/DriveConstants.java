...
public class DriveConstants {
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = null; // TODO: run DriveVelocityPIDTuner and update this after
     ...
     */
    public static double WHEEL_RADIUS = 2.953; // inches rounded to 3 decimal places
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 1; // TODO: measure this in inches to 3 decimals
