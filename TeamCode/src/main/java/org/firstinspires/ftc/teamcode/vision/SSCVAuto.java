...
//@Disabled
public class SSCVAuto extends OpenCvPipeline {
    ...
    public SSCVAuto(int width, int height) {
        this(width, height, 25, 25, 50, 50);
    }

    public SSCVAuto(int width, int height, double firstSkystonePositionPercentage,
