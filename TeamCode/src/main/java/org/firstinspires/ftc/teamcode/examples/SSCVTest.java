...
import org.firstinspires.ftc.teamcode.vision.SSCVAuto;
...
public class SSCVTest extends OpMode {

    private SSCVAuto skystoneDetector;
    ...
    public void init() {
         ...
         */
        skystoneDetector = new SSCVAuto(FRAME_WIDTH, FRAME_HEIGHT);
